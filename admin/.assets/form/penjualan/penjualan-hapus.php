	<form method="post" action="">
		...
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12 text-right">
				<button class="mt-1 btn btn-primary save_data" style="margin:20px 0px 0px 0px!important;" name="hapus_penjualan">
					Hapus
				</button>
	...
	<?php 
		...
		{	
			$id = $_POST['id']; 
			$query = mysqli_query($koneksi,"delete from db_penjualan where id='$id'");
