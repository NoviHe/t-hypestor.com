	<div id="printarea" class="row">
		<div class="col-sm-12 col-md-12 col-xl-12">
			<div class="main-card mb-3 card" style="border:none;">
				...
				<?php
					$no = 1;
					$query = mysqli_query($koneksi,"select * from db_penjualan where tanggal >= '$tanggal_awal 00:00:00' and tanggal <= '$tanggal_akhir 23:59:59'");
				?>					
						...
						<tbody>					
							...
							<tr>		
								...
								<td class="nominal_cetak" style="text-align:right; padding-right:8px; font-weight:bold;">
									<?php
										$data = mysqli_query($koneksi,"select sum(harga) as jml_penjualan_cetak from db_penjualan where tanggal >= '$tanggal_awal 00:00:00' and tanggal <= '$tanggal_akhir 23:59:59'");
										$d = mysqli_fetch_assoc($data);
										$jml_penjualan_cetak = $d['jml_penjualan_cetak'];
									?>
									Rp. 
									<?php 
										echo number_format($jml_penjualan_cetak,0,',','.');
									?>
								</td>				
							</tr>	
						</tbody>
