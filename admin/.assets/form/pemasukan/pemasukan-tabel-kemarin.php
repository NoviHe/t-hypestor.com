	<table id="tabel" class="table table-hover table-striped table-bordered" style="width:100%; font-size:13px; margin-top:7px;">
		<thead>
			<tr>
				...
				<th style="text-align:center; background:#eee;">Produk</th>
				<th style="text-align:center; background:#eee;">Cabang</th>
				<th style="text-align:center; background:#eee;">Harga</th>
			</tr>
		</thead>
		<tbody>			
		<?php
			$no = 1;
			$data = mysqli_query($koneksi,"select * from db_pemasukan where date(tanggal)='$tgl_kemarin'");
