	<div class="row">
		<div class="col-lg-12 col-xl-6">
			<a class="text-danger" href="" data-toggle="modal" data-target="#modals_pemasukan_bulan" data-backdrop="static" data-keyboard="false" style="text-decoration:none;">
		...
		<div class="col-lg-12 col-xl-6">
			<div class="main-card mb-3 card">
				<div class="grid-menu grid-menu-1col">
					<div class="no-gutters row">
						<div class="col-sm-6">
							<a class="text-danger" href="" data-toggle="modal" data-target="#modals_pemasukan_hari" data-backdrop="static" data-keyboard="false" style="text-decoration:none;">
								<div class="widget-chart widget-chart-hover" style="padding:20px 0px 94px 0px;">
									...
									<div class="widget-numbers" style="font-size:20px; margin-bottom:20px;">
										Rp. 
										<?php 
											echo number_format($jml_pemasukan_hari,0,',','.');
										?>
									</div>
									<div class="widget-subheading text-danger" style="font-weight:500; font-size:12px;">
										...
										<br>
										<?php echo $jml_pemasukan_hari_no;?> Data
									</div>
									<div class="widget-chart-wrapper">
						...
						<div class="col-sm-6">
							<a class="text-danger" href="" data-toggle="modal" data-target="#modals_pemasukan_kemarin" data-backdrop="static" data-keyboard="false" style="text-decoration:none;">
								<div class="widget-chart widget-chart-hover" style="padding:20px 0px 94px 0px;">
									<h5 class="menu-header-title text-danger" style="font-size:13px; margin-bottom:30px;">
										Pemasukan Kemarin
									</h5>
									<div class="widget-numbers" style="font-size:20px; margin-bottom:20px;">
										Rp. 
										<?php 
											echo number_format($jml_pemasukan_kemarin,0,',','.');
										?>
									</div>
									<div class="widget-subheading text-danger" style="font-weight:500; font-size:12px;">
										<?php echo tgl_Indonesia(date('d F Y', strtotime($tgl_kemarin)));?>
										<br>
										<?php echo $jml_pemasukan_kemarin_no;?> Data
									</div>
									<div class="widget-chart-wrapper">
						...
						<div class="col-sm-6">
							<a class="text-danger" href="" data-toggle="modal" data-target="#modals_pemasukan_minggu" data-backdrop="static" data-keyboard="false" style="text-decoration:none;">
								<div class="widget-chart widget-chart-hover" style="padding:20px 0px 94px 0px;">
									<h5 class="menu-header-title text-danger" style="font-size:13px; margin-bottom:30px;">
									...
									<div class="widget-numbers" style="font-size:20px; margin-bottom:20px;">
										Rp. 
										<?php 
											echo number_format($jml_pemasukan_minggu,0,',','.');
										?>
									</div>
									<div class="widget-subheading text-danger" style="font-weight:500; font-size:12px;">
										...
										<br>
										<?php echo $jml_pemasukan_minggu_no;?> Data
									</div>
									 <div class="widget-chart-wrapper">
						...
						<div class="col-sm-6">
							<a class="text-danger" href="" data-toggle="modal" data-target="#modals_pemasukan_tahun" data-backdrop="static" data-keyboard="false" style="text-decoration:none;">
								<div class="widget-chart widget-chart-hover" style="padding:20px 0px 94px 0px;">
									<h5 class="menu-header-title text-danger" style="font-size:13px; margin-bottom:30px;">
										Pemasukan Tahun Ini
									</h5>
									<div class="widget-numbers" style="font-size:20px; margin-bottom:20px;">
										Rp. 
										<?php 
											echo number_format($jml_pemasukan_tahun,0,',','.');
										?>
									</div>
									<div class="widget-subheading text-danger" style="font-weight:500; font-size:12px;">
										Tahun <?php echo tgl_Indonesia(date('Y'));?>
										<br>
										<?php echo $jml_pemasukan_tahun_no;?> Data
									</div>
									 <div class="widget-chart-wrapper">
			...
			<div class="main-card mb-3 card" style="padding-bottom:0px;">
				<div class="card-header-tab card-header">
					<div class="card-header-title judul_table">
						<a href="main?pg=pemasukan-cetak">
					...
					<div class="btn-actions-pane-right actions-icon-btn mobile_hide" style="margin-right:5px;">
						<div class="btn-group dropdown">
							<a class="text-danger" href="" data-toggle="modal" data-target="#modals_tambah_pemasukan" data-backdrop="static" data-keyboard="false">
				...
				<div class="mobile_hide" style="padding:15px;">
					<table id="tabel" class="table table-hover table-striped table-bordered" style="width:100%;">
						...
						<tr>
							<td>
								<a class="text-danger" href="" data-toggle="modal" data-target="#modals_hapus_pemasukan_<?php echo $d['id'];?>" data-backdrop="static" data-keyboard="false">
							...
							<td>
								<a class="text-danger" href="" data-toggle="modal" data-target="#modals_edit_pemasukan_<?php echo $d['id'];?>" data-backdrop="static" data-keyboard="false" style="text-decoration:none; font-weight:500;">
									<?php echo $d['id'];?>
								</a>
							</td>
							<td>
