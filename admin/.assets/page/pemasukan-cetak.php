										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-sm-12 col-md-12 col-xl-12" style="margin-bottom:100px;">
													<div class="mb-3 card">
														<div class="tabs-lg-alternate card-header no_print">
															<ul class="nav nav-justified">
																<li class="nav-item">
																	<a href="main?pg=pemasukan" class="nav-link active">
																...
																<li class="nav-item">
																	<a href="main?pg=pengeluaran" class="nav-link">
																		<div class="widget-number small_info">
																			<i class="pe-7s-box2 settings"></i> 
														...
														<div class="tab-content">
															<div class="tab-pane active" role="tabpanel">
																<div class="card-body" style="padding-top:30px; padding-bottom:0px;">
																	<?php include ".assets/form/pemasukan/pemasukan-cetak.php";?>
																</div>
															</div>
														</div>
													</div>	
