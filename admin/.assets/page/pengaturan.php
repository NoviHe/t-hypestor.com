													...
													<div class="mb-3 card">
														<div class="tabs-lg-alternate card-header">
															<ul class="nav nav-justified">
																<li class="nav-item">
																	<a href="main?pg=media" class="nav-link">
																...
																<li class="nav-item">
																	<a href="main?pg=pengaturan" class="nav-link active">
																		<div class="widget-number small_info">
																			<i class="pe-7s-box2 settings"></i> 
																...
																<li class="nav-item">
																	<a href="main?pg=ganti-password" class="nav-link">
																		<div class="widget-number small_info">
																			<i class="pe-7s-box2 settings"></i> 
														...
														<div class="tab-content">
															<div class="tab-pane active" role="tabpanel">
																<div class="card-body" style="padding-top:30px; padding-bottom:25px;">
																	<?php include ".assets/form/pengaturan.php";?>
																</div>
															</div>
														</div>
													</div>	
