	...
	"language": {
		...
		"info": "Total : <strong style='border-bottom:1px solid #000;'>_TOTAL_</strong> Data",
		...
		"infoFiltered": "<span style='display:block; margin-top:2px;'>disaring dari : <strong style='border-bottom:1px solid #000;'>_MAX_</strong> Total Data</span>"
	}